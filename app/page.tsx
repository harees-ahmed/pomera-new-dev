    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-br from-background via-secondary-light/10 to-accent/10">
        ...
        <div className="container mx-auto px-4 pt-8 pb-6">
          <div className="flex items-center justify-center max-w-6xl mx-auto">
            <div className="flex items-center space-x-8">
              <img 
                src={getAssetUrl("/lovable-uploads/86aabeb5-c86b-4e8e-8ea7-239349c6cae2.png")} 
        ...
        <div className="w-full py-0">
          <img 
            src={getAssetUrl("/lovable-uploads/a9eedb62-09ce-4fdc-9455-e5baa278633c.png")} 
        ...
        <div className="w-full py-1">
          <img 
            src={getAssetUrl("/lovable-uploads/ce4260ac-1d43-40cb-9e86-14dfb5fc5d5a.png")} 
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white/50 rounded-lg p-8 shadow-lg">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6 italic">
                Whether collaborating on a project or simply exchanging ideas, Aliza always adds value and insight. Her work ethic is unmatched, and she approaches every task with passion and purpose. Anyone who has the opportunity to work with Aliza is truly fortunate. She is not just an asset—she&apos;s a catalyst for growth and success.&rdquo;
              </p>
