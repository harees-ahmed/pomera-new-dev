...
import { PhoneIcon, SmartphoneIcon } from "./icons";
import {
  crmDatabase,
  type CompanyContact,
  type DimensionValue,
...
export default function ContactsSection({
  ...
  const handleAddContact = async () => {
    if (
      ...
      toast.error(
        "Please fill in all required fields (Contact Type, First Name, Last Name)"
      );
      return;
    }
    ...
    if (
      ...
      !validatePhoneNumber(newContact.contact_phone)
    ) {
    ...
    if (
      newContact.contact_mobile &&
      !validatePhoneNumber(newContact.contact_mobile)
    ) {
      ...
      {showAddForm && (
        <div className="mb-4 p-4 border rounded-lg bg-gray-50">
          ...
          <div className="flex gap-2 mt-4">
            <Button onClick={handleAddContact} size="sm" disabled={saving}>
